...
bool RFM69::initialize(uint8_t freqBand, uint8_t nodeID, uint8_t networkID, uint8_t bitRateMsb, uint8_t bitRateLsb)
{
  ...
  const uint8_t CONFIG[][2] =
  {
    ...
    /* 0x03 */ { REG_BITRATEMSB, bitRateMsb}, // default: 4.8 KBPS
